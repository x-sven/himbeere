function [time_vec, rpm_cmd_vec, rpm_state_vec] = dataset(data_struct)
...
rpm_state_vec  = signals.data(index_vec,9 -1);
...
rpm_cmd_vec =  rpm_cmd-  (rpm_cmd(16* 7.5) - signals.data(16* data_struct.T_min_rpm ,9 -1));
